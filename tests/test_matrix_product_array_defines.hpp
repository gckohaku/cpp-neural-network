...
std::array<T, Size> MakeArrayA() {
    return std::array<T, Size>{static_cast<T>(5.3), static_cast<T>(6.7), static_cast<T>(3.7), static_cast<T>(4.1),
        static_cast<T>(7.4), static_cast<T>(8), static_cast<T>(3.4), static_cast<T>(8.2), static_cast<T>(4.5)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeArrayB() {
    return std::array<T, Size>{static_cast<T>(5.7), static_cast<T>(5.5), static_cast<T>(0.3), static_cast<T>(8.3),
        static_cast<T>(2), static_cast<T>(1.4), static_cast<T>(7.2), static_cast<T>(3.1), static_cast<T>(7.9)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeExpectedArrayAB() {
    return std::array<T, Size>{static_cast<T>(53.78), static_cast<T>(81.35), static_cast<T>(66.44),
        static_cast<T>(56.95), static_cast<T>(81.89), static_cast<T>(53.01), static_cast<T>(77.73),
        static_cast<T>(135.96), static_cast<T>(86.99)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeExpectedArrayBA() {
    return std::array<T, Size>{static_cast<T>(112.46), static_cast<T>(54.02), static_cast<T>(40.2),
        static_cast<T>(142.39), static_cast<T>(62.15), static_cast<T>(74.79), static_cast<T>(119.84),
        static_cast<T>(49.05), static_cast<T>(48.05)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayAB() {
    return std::array<T, Size>{static_cast<T>(83.85), static_cast<T>(105.65), static_cast<T>(104.525),
        static_cast<T>(98), static_cast<T>(129), static_cast<T>(88.3), static_cast<T>(100), static_cast<T>(178.8),
        static_cast<T>(119.6)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayBA() {
    return std::array<T, Size>{static_cast<T>(160), static_cast<T>(78.2), static_cast<T>(45.425), static_cast<T>(221.2),
...
/* define C and D */
template <typename T, size_t Size>
std::array<T, Size> MakeArrayC() {
    return std::array<T, Size>{static_cast<T>(2.1), static_cast<T>(1.5), static_cast<T>(0.7), static_cast<T>(6),
...
template <typename T, size_t Size>
std::array<T, Size> MakeArrayD() {
    return std::array<T, Size>{static_cast<T>(2.4), static_cast<T>(1.5), static_cast<T>(3.6), static_cast<T>(6.3),
...
template <typename T, size_t Size>
std::array<T, Size> MakeExpectedArrayCD() {
    return std::array<T, Size>{static_cast<T>(72.02), static_cast<T>(44.08), static_cast<T>(55.85),
...
template <typename T, size_t Size>
std::array<T, Size> MakeExpectedArrayDC() {
    return std::array<T, Size>{static_cast<T>(47.44), static_cast<T>(61.91), static_cast<T>(20.81),
...
template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayDC() {
    return std::array<T, Size>{static_cast<T>(64.3), static_cast<T>(78.8), static_cast<T>(30.925),
...
/* define E and F */
template <typename T, size_t Size>
std::array<T, Size> MakeArrayE() {
    return std::array<T, Size>{static_cast<T>(3.1), static_cast<T>(2.1), static_cast<T>(6.3), static_cast<T>(4.6),
...
template <typename T, size_t Size>
std::array<T, Size> MakeArrayF() {
    return std::array<T, Size>{static_cast<T>(1.7), static_cast<T>(4.5), static_cast<T>(5.3), static_cast<T>(1.7),
...
template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayEF() {
    return std::array<T, Size>{static_cast<T>(91.3), static_cast<T>(54.8), static_cast<T>(100.4), static_cast<T>(55.35),
        static_cast<T>(40.3), static_cast<T>(68.45), static_cast<T>(62.3), static_cast<T>(42.2), static_cast<T>(68.6)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayFE() {
    return std::array<T, Size>{static_cast<T>(29.8), static_cast<T>(44.9), static_cast<T>(51.25), static_cast<T>(60.1),
...
/* define G and H */
template <typename T, size_t Size>
std::array<T, Size> MakeArrayG() {
    return std::array<T, Size>{static_cast<T>(3.5), static_cast<T>(6.2), static_cast<T>(4), static_cast<T>(5.4)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeArrayH() {
    return std::array<T, Size>{static_cast<T>(1.2), static_cast<T>(3.4), static_cast<T>(5.1), static_cast<T>(3.4),
...
template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayHG() {
    return std::array<T, Size>{static_cast<T>(87.1), static_cast<T>(54.8), static_cast<T>(120.2), static_cast<T>(69.6)};
}

/* define I and J */
template <typename T, size_t Size>
std::array<T, Size> MakeArrayI() {
    return std::array<T, Size>{static_cast<T>(4.1), static_cast<T>(3.6), static_cast<T>(1.7), static_cast<T>(2.4),
...
template <typename T, size_t Size>
std::array<T, Size> MakeArrayJ() {
    return std::array<T, Size>{static_cast<T>(2.7), static_cast<T>(1.6), static_cast<T>(3.5), static_cast<T>(2.2),
...
template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayJI() {
    return std::array<T, Size>{static_cast<T>(36.6), static_cast<T>(23.85), static_cast<T>(29.7), static_cast<T>(19.05),
...
/* define K */
template <typename T, size_t Size>
std::array<T, Size> MakeArrayK() {
    return std::array<T, Size>{static_cast<T>(0.0), static_cast<T>(-1.0), static_cast<T>(1.0), static_cast<T>(0.0)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeExpectedArrayKK() {
    return std::array<T, Size>{static_cast<T>(-1.0), static_cast<T>(0.0), static_cast<T>(0.0), static_cast<T>(-1.0)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeAcceptableErrorArrayKK() {
    return std::array<T, Size>{static_cast<T>(0.0), static_cast<T>(0.0), static_cast<T>(0.0), static_cast<T>(0.0)};
}

/* define M and N */
template <typename T, size_t Size>
std::array<T, Size> MakeArrayM() {
    return std::array<T, Size>{static_cast<T>(2.4), static_cast<T>(5.4), static_cast<T>(7.1), static_cast<T>(3.1),
        static_cast<T>(2.4), static_cast<T>(4.8)};
}

template <typename T, size_t Size>
std::array<T, Size> MakeArrayN() {
