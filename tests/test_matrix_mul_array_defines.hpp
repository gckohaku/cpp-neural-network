...
std::array<T, 2 * 5> MakeExpectedArrayCAndD() {
    return std::array<T, 2 * 5>{static_cast<T>(18.72), static_cast<T>(20.64), static_cast<T>(10.26),
        static_cast<T>(8.5), static_cast<T>(5.4), static_cast<T>(9.99), static_cast<T>(27.47), static_cast<T>(22.05),
        static_cast<T>(7.5), static_cast<T>(8.47)};
}

template <typename T>
std::array<T, 2 * 5> MakeAcceptableErrorArrayCAndD() {
    return std::array<T, 2 * 5>{static_cast<T>(24.8), static_cast<T>(36.4), static_cast<T>(12.9), static_cast<T>(11.8),
