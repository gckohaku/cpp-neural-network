...
std::vector<T> MakeExpectedVectorAAndB() {
    return std::vector<T>{static_cast<T>(-0.2), static_cast<T>(0.2), static_cast<T>(2), static_cast<T>(4.3),
...
std::vector<T> MakeExpectedVectorCAndD() {
    return std::vector<T>{static_cast<T>(1.6), static_cast<T>(-0.5), static_cast<T>(-3.9), static_cast<T>(-0.9),
