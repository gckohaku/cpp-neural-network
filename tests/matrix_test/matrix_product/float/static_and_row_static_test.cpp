...
BOOST_AUTO_TEST_CASE(matrix_static_and_matrix_row_static_test) {
    ...
    auto expectedAB =
        std::vector<float>{53.78f, 81.35f, 66.44f, 56.95f, 81.89f, 53.01f, 77.73f, 135.96f, 86.99f};
    auto expectedBA =
    ...
    auto arrayD = std::vector<float>{2.4f, 1.5f, 3.6f, 6.3f, 1.4f, 5.4f, 2.4f, 0.4f, 2.2f, 3.2f, 7.0f,
        3.0f, 2.3f, 4.7f, 4.4f, 3.6f, 7.5f, 0.8f, 3.0f, 0.3f, 3.0f, 3.1f, 2.4f, 0.1f, 0.8f};

    auto expectedCD = std::vector<float>{72.02f, 44.08f, 55.85f, 70.99f, 35.95f, 45.74f, 42.34f, 40.62f,
        57.58f, 31.48f, 81.05f, 65.23f, 69.77f, 94.0f, 49.71f, 55.41f, 44.14f, 54.89f, 69.86f, 49.01f, 35.46f, 23.94f,
        38.39f, 50.01f, 30.79f};
    auto expectedDC = std::vector<float>{47.44f, 61.91f, 20.81f, 38.08f, 14.7f, 90.24f, 73.39f, 39.01f,
    ...
    auto acceptableErrorDC = std::vector<float>{64.3f, 78.8f, 30.925f, 55.7125f, 21.7f, 127.8f, 108.0f,
    ...
    auto arrayF =
        std::vector<float>{1.7f, 4.5f, 5.3f, 1.7f, 3.4f, 3.7f, 0.5f, 3.5f, 1.5f, 1.4f, 3.4f, 4.3f};

    auto expectedEF =
        std::vector<float>{58.78f, 36.47f, 67.34f, 42.01f, 31.38f, 52.51f, 43.05f, 27.42f, 48.74f};
    auto expectedFE = std::vector<float>{21.86f, 30.54f, 38.9f, 39.71f, 27.45f, 40.97f, 42.21f, 40.98f,
    ...
    auto acceptableErrorFE = std::vector<float>{29.8f, 44.9f, 51.25f, 60.1f, 36.3f, 61.5f, 65.45f, 61.8f,
