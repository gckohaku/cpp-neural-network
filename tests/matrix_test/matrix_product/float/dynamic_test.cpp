#ifndef TESTS_MATRIX_TESTS_MATRIX_PRODUCT_FLOAT_DYNAMIC_TEST_CPP
#define TESTS_MATRIX_TESTS_MATRIX_PRODUCT_FLOAT_DYNAMIC_TEST_CPP
...
BOOST_AUTO_TEST_CASE(matrix_dynamic_test) {
    // square x square
    // 3x3
    ...
    auto A = MatrixDynamic<float>(row1, column1, arrayA);
    auto B = MatrixDynamic<float>(row1, column1, arrayB);
    ...
    auto typeCheckAB = std::is_same<decltype(AB), MatrixDynamic<float>>::value;
    auto typeCheckBA = std::is_same<decltype(BA), MatrixDynamic<float>>::value;
    ...
    auto C = MatrixDynamic<float>(row2, column2, arrayC);
    auto D = MatrixDynamic<float>(row2, column2, arrayD);
    ...
    auto typeCheckCD = std::is_same<decltype(CD), MatrixDynamic<float>>::value;
    auto typeCheckDC = std::is_same<decltype(DC), MatrixDynamic<float>>::value;
    ...
    auto E = MatrixDynamic<float>(rowE, columnE, arrayE);
    auto F = MatrixDynamic<float>(rowF, columnF, arrayF);
    ...
    auto typeCheckEF = std::is_same<decltype(EF), MatrixDynamic<float>>::value;
    auto typeCheckFE = std::is_same<decltype(FE), MatrixDynamic<float>>::value;
    ...
    auto G = MatrixDynamic<float>(rowG, columnG, arrayG);
    auto H = MatrixDynamic<float>(rowH, columnH, arrayH);
    ...
    auto typeCheckHG = std::is_same<decltype(HG), MatrixDynamic<float>>::value;
    ...
    auto I = MatrixDynamic<float>(rowI, columnI, arrayI);
    auto J = MatrixDynamic<float>(rowJ, columnJ, arrayJ);
    ...
    auto typeCheckJI = std::is_same<decltype(JI), MatrixDynamic<float>>::value;
    ...
    auto K = MatrixDynamic<float>(rowK, columnK, arrayK);
    ...
    auto KK = K.Dot(K);
    auto typeCheckKK = std::is_same<decltype(KK), MatrixDynamic<float>>::value;
