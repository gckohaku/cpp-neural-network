...
BOOST_AUTO_TEST_CASE_TEMPLATE(matrix_product_matrix_row_static_and_matrix_dynamic_test, T, MatrixProductCheckType) {
    // square x square
    // 3x3
    ...
    auto L = MatrixRowStatic<T, rowJ>(columnJ, arrayJ);
