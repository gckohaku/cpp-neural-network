...
BOOST_AUTO_TEST_CASE_TEMPLATE(matrix_product_matrix_static_and_matrix_column_static_test, Cases, CheckTypeCases) {
    ...
    // constexpr size_t elementSizeI = rowI * columnI;Vector
