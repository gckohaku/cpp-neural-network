...
template <typename K>
concept MatrixElement = SingleFloatingPoint<K> && DoubleFloatingPoint<K> && SingleFloatingComplex<K> && DoubleFloatingComplex<K> && AdditionalFloatingConcept<K>;
#else
template <typename K>
concept MatrixElement = SingleFloatingPoint<K> && DoubleFloatingPoint<K> && SingleFloatingComplex<K> && DoubleFloatingComplex<K>;
#endif
